...
/* Definitions for peripheral AXI_GPIO_CONTROL */
#define XPAR_AXI_GPIO_CONTROL_BASEADDR 0x41210000
#define XPAR_AXI_GPIO_CONTROL_HIGHADDR 0x4121FFFF
#define XPAR_AXI_GPIO_CONTROL_DEVICE_ID 0
#define XPAR_AXI_GPIO_CONTROL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_CONTROL_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_POLYNOMIAL */
#define XPAR_AXI_GPIO_POLYNOMIAL_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_POLYNOMIAL_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_POLYNOMIAL_DEVICE_ID 1
#define XPAR_AXI_GPIO_POLYNOMIAL_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_POLYNOMIAL_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_RESULT */
#define XPAR_AXI_GPIO_RESULT_BASEADDR 0x41220000
#define XPAR_AXI_GPIO_RESULT_HIGHADDR 0x4122FFFF
#define XPAR_AXI_GPIO_RESULT_DEVICE_ID 2
#define XPAR_AXI_GPIO_RESULT_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_RESULT_IS_DUAL 1


/* Definitions for peripheral AXI_GPIO_BTNS */
#define XPAR_AXI_GPIO_BTNS_BASEADDR 0x41240000
#define XPAR_AXI_GPIO_BTNS_HIGHADDR 0x4124FFFF
#define XPAR_AXI_GPIO_BTNS_DEVICE_ID 3
#define XPAR_AXI_GPIO_BTNS_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_BTNS_IS_DUAL 1
...
#define XPAR_AXI_GPIO_LED_DEVICE_ID 4
...
/* Canonical definitions for peripheral AXI_GPIO_CONTROL */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_CONTROL_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 1

/* Canonical definitions for peripheral AXI_GPIO_POLYNOMIAL */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_GPIO_POLYNOMIAL_DEVICE_ID
...
#define XPAR_GPIO_2_DEVICE_ID XPAR_AXI_GPIO_RESULT_DEVICE_ID
...
#define XPAR_GPIO_3_DEVICE_ID XPAR_AXI_GPIO_BTNS_DEVICE_ID
...
#define XPAR_GPIO_4_DEVICE_ID XPAR_AXI_GPIO_LED_DEVICE_ID
