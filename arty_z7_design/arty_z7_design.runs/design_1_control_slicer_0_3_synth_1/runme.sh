...
HD_PWD='C:/Users/macie/Desktop/testcases/mentor_security_trng_2.0/arty_z7_design/arty_z7_design.runs/design_1_control_slicer_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_control_slicer_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_control_slicer_0_3.tcl
