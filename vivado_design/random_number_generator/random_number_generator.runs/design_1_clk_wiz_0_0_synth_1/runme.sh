...
HD_PWD='D:/aio/testcases/mentor/security/proof_of_concept/vivado_design/random_number_generator/random_number_generator.runs/design_1_clk_wiz_0_0_synth_1'
cd "$HD_PWD"
