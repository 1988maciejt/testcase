...
begin
\genblk1[0].ic_i\: entity work.design_1_ro_injector_0_0_inv_chain_v2
     port map (
      O(0) => O(0),
      enable => enable
    );
\genblk1[16].ic_i\: entity work.\design_1_ro_injector_0_0_inv_chain_v2__parameterized0\
     port map (
      O(0) => O(1),
      enable => enable
    );
\genblk1[32].ic_i\: entity work.\design_1_ro_injector_0_0_inv_chain_v2__parameterized1\
     port map (
      O(0) => O(2),
      enable => enable
    );
\genblk1[48].ic_i\: entity work.\design_1_ro_injector_0_0_inv_chain_v2__parameterized2\
     port map (
      O(0) => O(3),
      enable => enable
    );
...
entity design_1_ro_injector_0_0 is
  ...
  attribute X_CORE_INFO of design_1_ro_injector_0_0 : entity is "ro_injector,Vivado 2021.1";
